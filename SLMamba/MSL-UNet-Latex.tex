...
% 标题信息
%\title{SLMamba: High-Performance U-Net Based on Vision Mamba and Strip Large-Kernel Convolution}
...
\noindent{\textbf{Keywords: }Medical Image Segmentation; Vision Mamba; Strip Convolution; Multi-scale Large-kernel Convolution}
